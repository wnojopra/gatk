...
public class SVTestUtils {
    ...
    public static SVCallRecord newDeletionCallRecordWithId(final String id) {
        return new SVCallRecord(id, "chr1", 1, true, "chr1", 100, false,
                GATKSVVCFConstants.StructuralVariantAnnotationType.DEL, 100, PESR_ONLY_ALGORITHM_LIST, Collections.emptyList(),
                Collections.emptyList(), Collections.emptyMap());
    }

    public static SVCallRecord newDeletionCallRecordWithIdAndAlgorithms(final String id, final List<String> algorithms) {
        return new SVCallRecord(id, "chr1", 1, true, "chr1", 100, false,
                GATKSVVCFConstants.StructuralVariantAnnotationType.DEL, 100, algorithms, Collections.emptyList(),
                Collections.emptyList(), Collections.emptyMap());
    }
    ...
    public static SVCallRecord newBndCallRecordWithStrands(final boolean strandA, final boolean strandB) {
        return new SVCallRecord("", "chr1", 1000, strandA, "chr1", 1000, strandB, GATKSVVCFConstants.StructuralVariantAnnotationType.BND, null,
    ...
    public static SVCallRecord newCtxCallRecord() {
        return new SVCallRecord("", "chr1", 1000, null, "chr1", 1000, null, GATKSVVCFConstants.StructuralVariantAnnotationType.CTX, null,
                Collections.singletonList(PESR_ALGORITHM),
                Collections.emptyList(),
                Collections.emptyList(),
                Collections.emptyMap());
    ...
    public static SVCallRecord newCpxCallRecordWithLength(final int length) {
        return new SVCallRecord("", "chr1", 1000, null, "chr1", 1000, null, GATKSVVCFConstants.StructuralVariantAnnotationType.CPX, length,
                Collections.singletonList(PESR_ALGORITHM),
                Collections.emptyList(),
                Collections.emptyList(),
                Collections.emptyMap());
    ...
    public static SVCallRecord newCnvCallRecordWithStrands(final Boolean strandA, final Boolean strandB) {
        return new SVCallRecord("", "chr1", 1000, strandA, "chr1", 1999, strandB, GATKSVVCFConstants.StructuralVariantAnnotationType.CNV, 1000,
                Collections.singletonList(GATKSVVCFConstants.DEPTH_ALGORITHM),
                Collections.emptyList(),
                Collections.emptyList(),
                Collections.emptyMap());
    ...
    public static SVCallRecord newCallRecordWithCoordinates(final String id, final String chrA, final int posA, final String chrB, final int posB) {
        return new SVCallRecord(id, chrA, posA, true, chrB, posB, false, GATKSVVCFConstants.StructuralVariantAnnotationType.BND, null,
    ...
    public static SVCallRecord newCallRecordWithAlgorithms(final List<String> algorithms) {
        return new SVCallRecord("", "chr1", 1000, true, "chr1", 1000, false, GATKSVVCFConstants.StructuralVariantAnnotationType.INS, length,
                algorithms,
                Collections.emptyList(),
                Collections.emptyList(),
                Collections.emptyMap());
