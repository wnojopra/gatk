...
public class AssemblyRegionArgumentCollection implements Serializable {
    ...
    public static final String PHASING_BUFFER_LONG_NAME = "phasing-buffer";
    ...
    public static final int DEFAULT_PHASING_BUFFER = 50;
    ...
    @Argument(fullName = PHASING_BUFFER_LONG_NAME, doc = "Buffer for keeping neighboring variants in the same assembly for phasing", optional = true)
    public int phasingBuffer = defaultPhasingBuffer();
    ...
    /**
     * @return Default value for the {@link #phasingBuffer} parameter, if none is provided on the command line
     */
    protected int defaultPhasingBuffer() { return DEFAULT_PHASING_BUFFER; }
    ...
    public void validate() {
        if ( maxAssemblyRegionSize <= 0 ) {
            throw new CommandLineException.BadArgumentValue("max assembly region size must be > 0");
        }
